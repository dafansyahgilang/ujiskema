		...
		<div class="container">
			<div class="row  d-flex justify-content-center">
				<div class="col-md-6">
					<div class="card border-primary"> 
						...
						<div class="card-title">
							<div class="border-bottom border-primary">
								<h3 class="text-center mt-3">Login pemilih</h3>
							</div>
						</div>
						<div class="card-body">
							<form action="<?= base_url('log/process') ?>" method="post">
					...
					<a class="btn btn-primary mt-3" href="<?=base_url('auth/logout')?>">admin <span class="sr-only"></span></a>
